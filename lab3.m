...
if (x > y)                           % Check if x is greater than y
    fprintf('%d is bigger than %i', x, y)  % If x is greater than y, print the message indicating that x is bigger than y
elseif (x < y)                       % If x is not greater than y, check if x is less than y
    fprintf('%d is less than %i', x, y)   % If x is less than y, print the message indicating that x is less than y
elseif (x == y)                      % If x is neither greater than nor less than y, check if x is equal to y
    fprintf('%d is equal to %i', x, y)     % If x is equal to y, print the message indicating that x is equal to y
end